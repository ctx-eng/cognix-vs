...
export interface Message {
  ...
  // content used to be text, but starting from api-version 7, we require Cognix clients to
...
export type MessagePart =
  ...
  | { type: 'context_file'; uri: string; content?: string } // Cognix extension
  | { type: 'context_repo'; repoId: string } // Cognix extension
