 ...
 */
export async function getSerializedParams(params: CompletionParameters): Promise<SerializedCompletionParameters> {
  return {
    ...params,
...
async function serializePrompts(messages: Message[], modelID?: string): Promise<SerializedChatMessage[]> {
