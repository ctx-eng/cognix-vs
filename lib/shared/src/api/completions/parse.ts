...
function parseEventData(builder: CompletionsResponseBuilder, eventType: Event['type'], dataLine: string): Event | Error {
...
export function parseEvents(builder: CompletionsResponseBuilder, eventsBuffer: string): EventsParseResult | Error {
